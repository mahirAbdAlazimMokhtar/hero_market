...
|-----------|-----------|
| ![Light Mode](https://github.com/user-attachments/assets/ea2330db-7481-40a8-9fbb-7fa21d74b0b3) | ![Light Mode](https://github.com/user-attachments/assets/5b2ed580-e5eb-4a29-90ec-92aea5676075) |
...
| 🌙 Dark Mode | 🌙 Dark Mode|
|-----------|-----------|
| ![Dark Mode](https://github.com/user-attachments/assets/e835cc58-0a0a-4a8c-bae0-9e8ff7cced94) | ![Dark Mode](https://github.com/user-attachments/assets/4adf39db-b1a9-49e0-8790-df4019aa0d15) |
...
|-----------|-----------|
| ![Light Mode](https://github.com/user-attachments/assets/5dd19821-13fa-435c-b58e-7eb5487d02fe) | ![Light Mode](https://github.com/user-attachments/assets/7a0dfef0-53a0-4c7b-b271-1495ab73457c) |
...
| Light Mode | Dark Mode |
|-----------|-----------|
| ![Light Mode](https://github.com/user-attachments/assets/3c8515c3-3d14-43a8-9bb5-8136dbebea9b) | ![Dark Mode](https://github.com/user-attachments/assets/7ca0d44c-e94f-4824-bc78-9badf926525a) |
...
- **Tabs Included**:
  ...
  - **Wishlist** ❤️
  - **Profile** 👤
- Enhances navigation with an intuitive and modern design.
- Supports both **Light** and **Dark** modes for a consistent user experience.

### 📂 App Drawer (New Feature 🎉)

We've introduced a **sleek and functional** App Drawer for easy navigation and quick access! 🚀

#### 🔹 Features

- **User Profile Section**: Displays the user's avatar and name at the top.
...
- **Sign Out Button** 🔑: Provides a smooth logout experience.

#### 🎨 UI Preview

| Dark Mode | Light Mode |
|-----------|-----------|
| ![Dark Mode](https://github.com/user-attachments/assets/be97ab82-9bb2-4572-abc4-6a590ced4216) | ![Light Mode](https://github.com/user-attachments/assets/7a4e77f9-2ad7-429e-a94f-f3338afc4ea7) |

---

### 🆕 Card Bottom Sheet (New Feature 🎉)

We've added a **Card Bottom Sheet** to enhance user interaction! 🚀
...
| Light Mode | Dark Mode |
|-----------|-----------|
| ![Light Mode](https://github.com/user-attachments/assets/6a4eaf8c-fdfc-4bed-a90c-958442658a88) | ![Dark Mode](https://github.com/user-attachments/assets/6a28be8f-f5b9-4db2-b970-43eacde2662c) |
...
- **OnBoarding Screens**
  ...
  - Smooth animations for a modern and engaging user flow.
...
- **Register Screen UI**
  - User-friendly and elegant interface to simplify the registration process.
  - Real-time validation for form fields.

- **Confirm Email (Forgot Password) Screen UI**
  - Clean and intuitive design for verifying emails and resetting passwords efficiently.
  - OTP-based authentication for secure verification.
...
- **Forgot Password Feature**
  ...
  - Adaptive UI for both mobile and tablet devices.
...
- **App Drawer**
  - **User Profile Section**: Displays the user’s avatar and name.
  - **Quick Access Pages**:
    - **Profile** 👤
    - **Payment Profile** 💳
    - **Wishlist** ❤️
    ...
    - **Terms and Conditions** 📜
  - **Dark Mode Toggle 🌙**.
  - **Sign Out Button** with a confirmation prompt.
...
- **🆕 Card Bottom Sheet (New Feature 🎉)**
  ...
  - **Consistent Theme Support** (Light & Dark Modes).
  - **User-friendly button arrangement** for better accessibility.

- **🆕 Theme Toggle Button (New Feature 🎨)**
  - Added a **toggle button** to switch between **Light Mode** and **Dark Mode** dynamically.
  - Saves the user’s theme preference for future sessions.
  - Ensures a **consistent experience** across the app.
  - Smooth transition animation when switching themes.
  - Fully integrated with **Material 3** and **adaptive colors**.
...
│   │   ├── constants.dart
│   │   ├── theme.dart
│   │   ├── theme_provider.dart  <-- New file for managing theme switching
│   ├── error/
│   │   ├── exceptions.dart
│   │   ├── failures.dart
│   ├── usecases/
...
│       ├── presentation/
│       │   ├── widgets/
│       │   │   ├── signout_bottom_sheet.dart
│       ├── domain/
│       │   ├── usecases/
│       │       ├── confirm_signout.dart
│       ├── data/
│           ├── repositories/
│           │   ├── bottom_sheet_repository_impl.dart
│           ├── datasources/
│               ├── bottom_sheet_local_datasource.dart
│   ├── settings/
│       ├── presentation/
│       │   ├── widgets/
│       │   │   ├── theme_toggle_button.dart  <-- New widget for theme toggle
│       ├── domain/
│       │   ├── usecases/
│       │       ├── change_theme.dart
│       ├── data/
